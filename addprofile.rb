...
def getTimestamp
  ...
  if name == "ad.min"
    ...
    if name == Ted_Franks
      puts "pic1"
    elsif name == William_Mooney
      puts "pic2"
    elsif name = Marc_Macariola
      puts "pic3"
    elsif name == Dea_Lorenzo
      puts "pic4"
    elsif name == Reggie_Cabutotan
  puts "pic4"
    elsif name == Shane_Clark
  puts "pic4"
...
def adminScreen
  ...
  banner();
  p "Welcome Admin.";
  #p "Not finished..you will be redirected in 10 seconds.";
  #sleep(10);
  #introScreen();
  adminOptions();
end
...
def adminOptions #### Working but incomplete ##########
  ...
  p "3 - Coming Soon - Print individual Timestamp's";
